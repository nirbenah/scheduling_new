...
def main(argv = None):
    ...
    solution_type.add_argument('-a', '--approx', help='prints an approximate scheudle by the approx solver', action = 'store_true')
    solution_type.add_argument('-ei', '--exact_ilp', help='prints a scheudle by exact_ilp', action = 'store_true')
